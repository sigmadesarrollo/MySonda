...
If Not clientes.BOF And Not clientes.EOF Then
    If frmVentas.tTab.SelectedTab = 1 Then
        ...
        frmVentas.txtApellidoPaterno2.text = clientes!ApellidoPaterno
        frmVentas.txtApellidoMaterno2.text = clientes!ApellidoMaterno
    ...
    Else
        ...
        frmVentas.txtApellidoPaterno.text = clientes!ApellidoPaterno
        frmVentas.txtApellidoMaterno.text = clientes!ApellidoMaterno
