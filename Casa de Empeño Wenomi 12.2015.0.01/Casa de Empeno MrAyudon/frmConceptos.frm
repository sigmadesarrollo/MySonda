...
Begin VB.Form frmConceptos 
   ...
   Begin DevPowerFlatBttn.FlatBttn cmdEliminar 
      ...
      TextColor       =   -2147483630
      Object.ToolTipText     =   ""
      Picture         =   "frmConceptos.frx":055E
      PictureDisabled =   "frmConceptos.frx":0AB0
   End
...
Private Sub cmdEliminar_Click()
    ...
    If grdConceptos.SelectedRow > 0 Then
        ...
        If MsgBox("Desea eliminar el concepto seleccionado ??", vbQuestion + vbYesNo + vbDefaultButton2, "Conceptos") = vbYes Then
            
            dbDatos.Execute "DELETE FROM conceptos WHERE ID=" & grdConceptos.CellItemData(grdConceptos.SelectedRow, 1)
...
Private Sub Crear_Encabezados()
    ...
    With grdConceptos
        ...
        .AddColumn "K1", "Concepto", ecgHdrTextALignLeft, , 272, , , , , , , CCLSortString
...
On Error GoTo error
    ...
    dbDatos.Execute "INSERT INTO conceptos (Descripcion) VALUES ('" & _
                    txtConcepto.text & "')"
...
On Error GoTo error
    ...
    rcConceptos.Open "SELECT * FROM conceptos", dbDatos, adOpenForwardOnly, adLockOptimistic
    With rcConceptos
