...
On Error GoTo Error
    ...
    'ORO-ELECTRONICOS
    SubQuery1 = "SELECT DISTINCT empeno.NumContrato As Folio, empeno.Fecha AS Fecha, concat(clientes.Nombre,' ',clientes.Apellido) AS Nombre, CONCAT(clientes.Direccion,' ',clientes.NoExterior,' ',clientes.NoInterior,' Col.',clientes.Colonia) as Domicilio,detallesempeno.Prestamo AS Prestamo, " & _
