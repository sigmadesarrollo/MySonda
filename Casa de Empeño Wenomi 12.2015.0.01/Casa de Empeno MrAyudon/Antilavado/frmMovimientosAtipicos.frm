...
Begin VB.Form frmMovimientosAtipicos 
   ...
   Begin TabDlg.SSTab TabFechas 
      ...
      Tab(1).Control(2)=   "cmdMosFecha(0)"
      Tab(1).Control(3)=   "cmdMosFecha(1)"
      Tab(1).Control(4)=   "txtHasta"
      Tab(1).Control(5)=   "txtDesde"
        ...
        If Not RsTipoAlerta.EOF Then
            Do While Not RsTipoAlerta.EOF
                ...
                If Not rsEmpeno.EOF Then
                    ...
                    Print #1, "  <aviso>"
                    Print #1, "    <referencia_aviso>" & CStr(Year(Date)) & "-" & vFolioAviso & "</referencia_aviso>"
                    ...
                    Do While Not rsEmpeno.EOF
                        ...
                        If Trim(rsEmpeno!Nacionalidad) = "MX" Then
                            ...
                            Print #1, "           <numero_interior>" & rsEmpeno.Fields("NoInterior") & "</numero_interior>"
                        ...
                        Print #1, "         <numero_telefono>" & Replace(rsEmpeno.Fields("Tel"), "-", "", 1) & "</numero_telefono>"
                        Print #1, "         <correo_electronico>" & rsEmpeno.Fields("Email") & "</correo_electronico>"
                        Print #1, "     </telefono>"
                        Print #1, "   </persona_aviso>"
                        ...
                        If rsEmpeno!IDCotitular <> 0 Then
                            ...
                            If Not RsDatosCoTitular.EOF Then
                                ...
                                If Trim(RsDatosCoTitular!Nacionalidad) = "MX" Then
                                    ...
                                    Print #1, "           <numero_interior>" & RsDatosCoTitular.Fields("NoInterior") & "</numero_interior>"
                                ...
                                '********************  TELEFONO  *********************
                                Print #1, "     <telefono>"
                                Print #1, "         <clave_pais>" & RsDatosCoTitular.Fields("Clave") & "</clave_pais>"
                                Print #1, "         <numero_telefono>" & Replace(RsDatosCoTitular.Fields("Tel"), "-", "", 1) & "</numero_telefono>"
                                Print #1, "         <correo_electronico>" & RsDatosCoTitular.Fields("Email") & "</correo_electronico>"
                                Print #1, "     </telefono>"
                                Print #1, "   </dueno_beneficiario>"
                        ...
                        If RsOperaciones.Fields("Serie") = SERIE_A Then
                            ...
                            If Not RsDetalle.EOF Then
                                ...
                                Do While Not RsDetalle.EOF
                                    ...
                                    Print #1, "              <datos_liquidacion>"
                                    Print #1, "                 <fecha_pago>" & Format(RsDetalle.Fields("FechaMovimiento"), "yyyyMMdd") & "</fecha_pago>"
                                    Print #1, "                 <instrumento_monetario>" & Trim(RsDetalle.Fields("ClaveInstMonetario")) & "</instrumento_monetario>"
                                    Print #1, "                 <moneda>" & Trim(RsDetalle.Fields("ClaveTipoMoneda")) & "</moneda>"
                                    Print #1, "                 <monto_operacion>" & RsDetalle.Fields("DPrestamo") & "</monto_operacion>"
                                    Print #1, "              </datos_liquidacion>"
