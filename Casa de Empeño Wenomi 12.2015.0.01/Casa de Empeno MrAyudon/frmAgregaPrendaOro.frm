...
Begin VB.Form frmAgregaPrendaOro 
   ...
   EndProperty
   Icon            =   "frmAgregaPrendaOro.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   1140
   ScaleWidth      =   5115
   ...
   Begin DevPowerFlatBttn.FlatBttn cmdSalir 
      ...
      Object.ToolTipText     =   ""
      Picture         =   "frmAgregaPrendaOro.frx":000C
   End
   Begin DevPowerFlatBttn.FlatBttn cmdAceptar 
      ...
      TextColor       =   4210752
      Object.ToolTipText     =   ""
      Picture         =   "frmAgregaPrendaOro.frx":055E
   End
   ...
   End
End
Attribute VB_Name = "frmAgregaPrendaOro"
...
Private Sub cmdAceptar_Click()
    ...
    If Trim(txtDescripcion.text) <> "" Then
        ...
        dbDatos.Execute "INSERT INTO tipoprenda (Descripcion,IDTipo) VALUES ('" & _
                        Trim(txtDescripcion.text) & "',1)"
        
        IDPrenda = SacaValor("tipoprenda", "MAX(ID)")
        Unload Me
    End If
